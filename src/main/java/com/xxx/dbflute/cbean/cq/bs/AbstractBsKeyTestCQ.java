...
/**
 * The abstract condition-query of key_test.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsKeyTestCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsKeyTestCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<KeyTestCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, KeyTestCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<KeyTestCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, KeyTestCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<KeyTestCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, KeyTestCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<KeyTestCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, KeyTestCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<KeyTestCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, KeyTestCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;KeyTestCB&gt;() {
     *     public void query(KeyTestCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<KeyTestCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, KeyTestCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        KeyTestCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(KeyTestCQ sq);

    protected KeyTestCB xcreateScalarConditionCB() {
        KeyTestCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected KeyTestCB xcreateScalarConditionPartitionByCB() {
        KeyTestCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<KeyTestCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        KeyTestCB cb = new KeyTestCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "id";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(KeyTestCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<KeyTestCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(KeyTestCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        KeyTestCB cb = new KeyTestCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "id";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(KeyTestCQ sq);
     ...
     */
    public void myselfExists(SubQuery<KeyTestCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        KeyTestCB cb = new KeyTestCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(KeyTestCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected KeyTestCB newMyCB() {
        return new KeyTestCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return KeyTestCQ.class.getName(); }
