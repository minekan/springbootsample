...
/**
 * The entity of id_test as TABLE.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsIdTest extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsIdTest) {
            BsIdTest other = (BsIdTest)obj;
