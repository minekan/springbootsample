 ...
 */
@Configuration
@ComponentScan(value="com.example.springbootsample.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    protected DBFluteInitializer newDBFluteInitializer(DataSource dataSource) {
        return new com.example.springbootsample.dbflute.allcommon.DBFluteInitializer(dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.example.springbootsample.dbflute.allcommon.ImplementedInvokerAssistant();
    }
